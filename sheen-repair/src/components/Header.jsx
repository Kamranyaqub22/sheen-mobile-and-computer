      ...
      <div className="bg-[#111111] shadow-[0_1px_0_rgba(255,255,255,0.06)]">
        <div className="max-w-[1440px] mx-auto flex h-[60px] items-center justify-between gap-4 px-4">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Link to="/checkout" className="relative p-2 text-white/70 hover:text-white transition-colors" aria-label={cartCount > 0 ? `Basket (${cartCount} items)` : 'Basket'}>
          ...
          {/* Mobile right side: basket + phone + hamburger */}
          <div className="flex items-center gap-1 lg:hidden">
            <Link to="/checkout" className="relative p-2 text-white" aria-label={cartCount > 0 ? `Basket (${cartCount} items)` : 'Basket'}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/>
                <line x1="3" y1="6" x2="21" y2="6"/>
                <path d="M16 10a4 4 0 01-8 0"/>
